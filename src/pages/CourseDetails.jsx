...
import { fetchDiseaseDetails } from "../services/operations/diseaseDetailsAPI"
...
function DiseaseDetails() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        const res = await fetchDiseaseDetails(diseaseId)
        // console.log("course details res: ", res)
        setResponse(res)
      } catch (error) {
        console.log("Could not fetch Disease Details")
      }
    })()
  }, [diseaseId])
