...
exports.createBlog = async (req, res) => {
  try {
    ...
    const imageForData = Array.isArray(req.files.images) ? req.files.images: [req.files.images];
  ...
  uploadedImageUrls.push(uploaded.secure_url); // or store the whole object if needed
  }
