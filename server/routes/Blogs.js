...
router.post("/createBlog", auth, isDoctor, createBlog)
router.put("/editBlog",auth,isDoctor,editBlog)
router.post('/getBlogDetails',getBlogDetails)
router.get('/getAllBlogs',getAllBlogs)
router.post('/getCreatorBlogs',getCreatorBlogs)
router.delete('/deleteBlog',auth,isDoctor,deleteBlog)
// ********************************************************************************************************
//                                      Category routes (Only by Admin)
// ********************************************************************************************************
// Category can Only be Created by Employee
// TODO: Put IsEmployee Middleware here
router.post("/createCategory", auth, isDoctor,createBlogsCategory)
