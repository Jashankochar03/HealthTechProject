...
from Acne_Prediction.entity.config_entity import (PrepareBaseModelConfig,PrepareCallbacksConfig,TrainingConfig,EvaluationConfig)
import os
...
class ConfigurationManager:
    ...
    def get_training_config(self) -> TrainingConfig:
        ...
        training_data = os.path.join(self.config.data_ingestion.unzip_dir,"Dataset_new")
    ...
    def get_validation_config(self) -> EvaluationConfig:
        eval_config = EvaluationConfig(
            ...
            training_data = Path("artifacts/data_ingestion/Dataset_new"),
